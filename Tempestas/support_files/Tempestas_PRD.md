...
**Description:**
Show daily weather forecast for the next 3 days (excluding today).

**Requirements:**
- Display next 3 days (Day 1, Day 2, Day 3)
- Each day shows:
  - Day name (e.g., "Monday", "Tomorrow")
  - Weather condition icon
  - High temperature
  - Low temperature
...
**Technical Notes:**
- Use WeatherKit daily forecast endpoint
...
- Search for locations by:
  ...
  - ZIP code
  - State/Country
- Display search results with disambiguation (e.g., "Portland, OR" vs "Portland, ME")
- Save up to 3 locations
- View weather for any saved location
- Delete saved locations
- Reorder saved locations (drag and drop)
- Show all locations on home screen with quick view data:
  - Location name
  - Current temperature
  - Current condition icon
- Tap location to see full details

**Technical Notes:**
- Use Apple MapKit for location search
- Store locations locally (UserDefaults or Core Data)
- Cache weather data per location separately
- Current location always shown first, marked with GPS icon
...
**Description:**
Implement intelligent caching to minimize WeatherKit API calls and improve performance.
...
- Use FileManager for persistent caching
- Implement cache expiration logic
- Clear old cache data (> 24 hours)
- Maximum 500,000 API calls/month (WeatherKit free tier)
- Estimated usage: ~150 calls/day for 1 user with 4 locations
...
### 6.3 Key Libraries/Dependencies
